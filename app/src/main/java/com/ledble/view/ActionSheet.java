...
////				imageView.setBackground(resources.getDrawable(items[i].getItemIconNormal()));
...
//				rl.addView(imageView);
				...
				textView.setTextColor(resources.getColor(items[i].getItemTextColorNormal()));
		...
		bt.setTextSize(TypedValue.COMPLEX_UNIT_PX, 40.0f);
		bt.setId(CANCEL_BUTTON_ID);

		bt.setBackground(resources.getDrawable(R.drawable.actionsheet_cancel_border));
...
//		}
		...
		public Item(int itemBackgroundNormal, int itemBackgroundPressed, int itemIconNormal, int itemIconPressed, int itemTextColorNormal, int itemTextColorPressed, String itemText) {
...
//			this.itemIconPressed = itemIconPressed;
		...
		public Item(int itemBackgroundNormal, int itemBackgroundPressed, int itemIconNormal, int itemIconPressed, int itemTextColorNormal, int itemTextColorPressed, String itemText, float itemBackgroundAlpha) {
			this.itemText = itemText;
			this.itemTextColorNormal = itemTextColorNormal;
			this.itemTextColorPressed = itemTextColorPressed;
//			this.itemIconNormal = itemIconNormal;
...
//			dest.writeInt(itemIconPressed);
	...
	public static interface ActionSheetListener {
		...
		void onOtherButtonClick(ActionSheet actionSheet, int index, String groupName);
	}
